...
public class facebook_navigation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_facebook_navigation);


        BottomNavigationView bottomNavigationView = findViewById(R.id.bottom_nav);
        bottomNavigationView.setSelectedItemId(R.id.Facebookk);
    ...
    AccessTokenTracker tokenTracker = new AccessTokenTracker() {
        ...
        protected void onCurrentAccessTokenChanged(AccessToken oldAccessToken, AccessToken currentAccessToken) {
            if(currentAccessToken==null){
                ...
                Toast.makeText(facebook_navigation.this, "user Logged out", Toast.LENGTH_SHORT).show();
            }
            else
        ...
        GraphRequest request =GraphRequest.newMeRequest(newAccessToken, new GraphRequest.GraphJSONObjectCallback() {
            ...
            public void onCompleted(JSONObject object, GraphResponse response) {
                try {
                    ...
                    Glide.with(facebook_navigation.this).load(image_url).into (circleImageView);
